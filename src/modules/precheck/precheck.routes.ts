...
import {
  getLatestApplicationPrecheck,
  getLatestCurrentApplicationPrecheck,
  runApplicationPrecheck,
} from './precheck.controller';
...
precheckRouter.get(
  '/applications/current/precheck/latest',
  requireAuth,
  requireRole(Role.student),
  asyncHandler(getLatestCurrentApplicationPrecheck),
);
precheckRouter.get(
